...
export class VehicleService  {
  ...
  getVehicle(){
    return this.http.get<any>(`${environment.apiUrl}/vehicle-details`)
  }
  getVehicleById(id:number): Observable<any> {
    return this.http.get<any>(`${environment.apiUrl}/vehicle-detail/${id}`);
  }
  postVehicle(data:any){
    return this.http.post<any>(`${environment.apiUrl}/vehicle-details`,data)
  }
  ...
  getVehicleList(page:number, size:number, sort:string, dir:string, searchTerm:string){
    return this.http.get<any>(`${environment.apiUrl}/vehicle-details-list?page=${page}&size=${size}&search=${searchTerm}&sortByField=${sort}&sortBy=${dir}`)
  ...
  getServiceItems(){
    return this.http.get<any>(`${environment.apiUrl}/service-items`)
  }
  ...
  getVehicleService(){
    return this.http.get<any>(`${environment.apiUrl}/vehicleService-details`)
  }
  ...
  postVehicleService(data:any){
    return this.http.post<any>(`${environment.apiUrl}/vehicleService-details`,data)
  }
  ...
  getVehicleServiceList(page:number, size:number, sort:string, dir:string, searchTerm:string){
    return this.http.get<any>(`${environment.apiUrl}/vehicleService-details-list?page=${page}&size=${size}&search=${searchTerm}&sortByField=${sort}&sortBy=${dir}`)
