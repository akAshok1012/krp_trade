...
export class BillingService {
  ...
  getPaymentByOrderId(id:number): Observable<any> {
    return this.http.get<any>(`${environment.apiUrl}/payment-orderId?order=${id}`);
  }
 ...
 getPaymentinvoice(page:number, size:number, dir:string, sort:string, searchTerm: string):Observable<any> {
   ...
   getPaymentinvoiceBySalesId(page:number, size:number, dir:string, sort:string, searchTerm: string):Observable<any> {
    return this.http.get<any>(`${environment.apiUrl}/salesOrder-BySalesId?page=${page}&size=${size}&sortBy=${dir}&sortByField=${sort}&salesId=${searchTerm}`);
   }

   getPaymentCustinvoiceBySalesId(id:number, page:number, size:number, dir:string, sort:string, searchTerm: string):Observable<any> {
    return this.http.get<any>(`${environment.apiUrl}/salesOrder-BySalesId?id=${id}&page=${page}&size=${size}&sortBy=${dir}&sortByField=${sort}&salesId=${searchTerm}`);
   }
 ...
 getViewPaymentBySalesId(id:number): Observable<any> {
  return this.http.get<any>(`${environment.apiUrl}/view-payment?salesId=${id}`);
}
getOutstandingPayment(id:number):Observable<any> {
  return this.http.get<any>(`${environment.apiUrl}/outstanding-order-payment?id=${id}`);
}
...
getExpensesCategory(): Observable<any> {
  return this.http.get<any>(`${environment.apiUrl}/expense-categories`);
}
...
// }
 ...
 getSalesOrderStatus(){
  return this.http.get<any>(`${environment.apiUrl}/salesorder-status?orderStatus=APPROVED`)
...
getEmployeePayConfigurationlist(page:number, size: number, dir: string, sort: string, searchTerm: string): Observable<any>{
 ...
 getIdEmployeePayConfigurationById(id:number): Observable<any> {
  return this.http.get<any>(`${environment.apiUrl}/employee-pay-configuration/${id}`);
}

editEmployeePayConfiguration(id:number,data:any): Observable<any> {
  return this.http.put<any>(`${environment.apiUrl}/employee-pay-configuration/${id}`,data);
}
postEmployeePayConfiguration(data:any): Observable<any> {
  return this.http.post<any>(`${environment.apiUrl}/employee-pay-configuration`,data)
}

deleteEmployeePayConfiguration(id:number): Observable<any> {
  return this.http.delete<any>(`${environment.apiUrl}/employee-pay-configuration/${id}`)
}
getIdEmployeePayConfiguration(): Observable<any> {
  return this.http.get<any>(`${environment.apiUrl}/employee-pay-configuration`);
}
